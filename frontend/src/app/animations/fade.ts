...
import { ReflectionAnimationCurves, ReflectionAnimationDurations } from './defaults';
...
const fadeIn = trigger('fadeIn',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${ReflectionAnimationDurations.entering} ${ReflectionAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const fadeOut = trigger('fadeOut',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${ReflectionAnimationDurations.exiting} ${ReflectionAnimationCurves.acceleration}`
                }
            }
        )
    ]
